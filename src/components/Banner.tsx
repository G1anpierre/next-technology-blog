...
export const Banner = ({
  info: {title, subtitle, description, image},
}: {
  info: {
    title: string
    subtitle: string
  ...
  return (
    <div className="relative isolate overflow-hidden bg-gray-900 px-6 py-24 sm:py-32 lg:px-8 ">
      <Image
        ...
        alt=""
        className="absolute inset-0 -z-10 h-full w-full object-cover brightness-50 object-center"
        layout="fill"
      />
      <div
      ...
      <div className="mx-auto max-w-2xl text-center">
        ...
        <p className="mb-6 text-sm leading-8 text-gray-300">{subtitle}</p>
